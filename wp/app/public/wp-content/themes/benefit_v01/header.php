  ...
  <header class="bl_mainHeader">
    ...
    <nav class="bl_mainHeader_right">
      <ul class="bl_mainHeader_list">
        ...
        <li><a href="https://famione.co.jp/benefit-contact/"
            class="bl_mainHeader_btn bl_mainHeader_btn--contact">お問い合わせ</a></li>
        <li><a href="https://famione.co.jp/benefit-download/"
            class="bl_mainHeader_btn bl_mainHeader_btn--document">資料請求</a></li>
      </ul>
    </nav>
  </header>
